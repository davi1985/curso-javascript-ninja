...
*/
var myArray = ['Davi', true, 32, 'Javascript', undefined];
...
*/
var myVar = ['Davi', 32, true, [1,2,'Silva'], {b:2}];

/*
Invoque a função criada acima, fazendo-a retornar todos os valores do último
array criado.
*/
console.log(twoParam(myVar, 0));
console.log(twoParam(myVar, 1));
console.log(twoParam(myVar, 2));
console.log(twoParam(myVar, 3));
console.log(twoParam(myVar, 4));
