(function(){
  ...
  */
  ...
  var davi = new Person('Davi','Silva',33);
  ...
  */
  ...
  // fernando.addAge(8);
  // joao.addAge(3);
  console.log(davi.getFullName() + ' agora tem '+ davi.addAge(2).getAge() + ' anos.');
  console.log(fernando.getFullName() + ' agora tem '+ fernando.addAge(8).getAge() + ' anos.');
