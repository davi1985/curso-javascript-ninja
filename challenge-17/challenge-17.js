(function() {
	...
	*/
	...
	console.log(text.replace(/Manuel Marques de Sousa/g, 'Davi Silva'));
	...
	*/
	...
	console.log(text.replace(/brasileiro/,'aracatiense'));
	...
	*/
	...
	// console.log(text.replace(/a/gi, 4)); // gi = ignore case;
